...
const AddRoom = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const success = await addRoomApi(newRoom.photo, newRoom.roomType, newRoom.roomPrice);
  ...
  return (
    <>
      <section className='container mt-5 mb-5'> {/* Removed comma */}
          ...
          <div className="col-md-8 col-lg-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='mb-3'>
                ...
                <input className='form-control' required id='roomPrice'
                  name='roomPrice' type='number' value={newRoom.roomPrice}
